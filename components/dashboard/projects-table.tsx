      ...
      <CardHeader>
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div>
            ...
            <CardDescription>Visão geral de todos os projetos ativos</CardDescription>
          </div>
          <Link href="/projects">
          ...
          <table className="w-full text-sm text-left">
            <thead className="text-xs text-gray-700 dark:text-gray-300 uppercase bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th scope="col" className="px-6 py-3">Data de Término</th>
            ...
            <tbody>
              {projects.map((project) => (
                ...
                >
                  ...
                  <td className="px-6 py-4">{formatDate(project.startDate, 'dd/MM/yyyy')}</td>
                  <td className="px-6 py-4">{formatDate(project.endDate, 'dd/MM/yyyy')}</td>
