  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Membros envolvidos nos projetos ativos</CardDescription>
      </CardHeader>
      <CardContent>
      ...
      <CardFooter className="border-t border-gray-200 dark:border-gray-800 px-6 py-4">
        <Link href="/users" className="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
          Ver toda a equipe
        </Link>
      </CardFooter>
    </Card>
