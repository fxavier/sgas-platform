...
export async function POST(req: Request) {
  try {
    ...
    const newRegistro =
      await prisma.identificacaoAvaliacaoDeRiscosImapctosAmbientaisSociais.create(
        {
          data: {
            ...rest,
            tenantId,
...
export async function PUT(req: Request) {
  try {
    ...
    const updatedRegistro =
      await prisma.identificacaoAvaliacaoDeRiscosImapctosAmbientaisSociais.update(
        {
          where: { id },
          data: {
            ...rest,
...
export async function DELETE(req: Request) {
  try {
    ...
    await prisma.identificacaoAvaliacaoDeRiscosImapctosAmbientaisSociais.delete(
      {
        where: { id },
      }
    );
